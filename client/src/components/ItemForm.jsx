            ...
            <form accept="image/gif,image/jpeg">
              ...
              <div className="form-group col-md-6 FileUpload">
                <div>
                  {this.state.dropZoneView ? (
                    ...
                    <div style={{ width: '210%' }}>
                      <p>
                        {this.state.uploadedFile.name} has been submitted. Thank
                        you
                      </p>
                      <button onClick={this.undoPictureUpload}>
                        Undo picture upload
                      </button>
                    </div>
                  )}
              ...
              <div>
                ...
                >
                  ...
                  <ModalBody>
                    <div
                      className="card text-center bg-secondary mb-3"
                      style={{ flex: 1, width: 375, height: 700 }}
                    >
                      <div className="card-body">
                        <h5 className="card-title text-white">
                          <strong>{this.state.name + ' '}</strong>
                          {this.state.condition === 'Pristine' && (
                          ...
                          {this.state.condition === 'Fair' && (
                            <span className="badge badge-success">
                              {this.state.condition}
                            </span>
                          )}
                          {this.state.condition === 'Terrible' && (
                        ...
                        <img
                          ...
                          src={this.state.uploadedCloudinaryURL}
                          alt="Card image cap"
                        />

      ...
      <div>
        ...
        {filterFunc(
          ...
          <div
            ...
            style={{ flex: 1, width: 375, height: 750 }}
          >
            <div className="card-body">
              <h5 className="card-title text-white">
                <strong>{this.props.item.name + ' '}</strong>
                {this.props.item.condition === 'Pristine' && (
                  <span className="badge badge-primary">
                    {this.props.item.condition}
                  </span>
                )}
                {this.props.item.condition === 'Good' && (
                  <span className="badge badge-info">
                    {this.props.item.condition}
                  </span>
                )}
                {this.props.item.condition === 'Fair' && (
                  <span className="badge badge-success">
                    {this.props.item.condition}
                  </span>
                )}
                {this.props.item.condition === 'Terrible' && (
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item text-black">
                  Asking price: ${this.props.item.cost}
                </li>
              ...
              {this.state.itemBought && (
                <button className="btn btn-red btn-sm btn-block" disabled>
                  Item purchased
                </button>
              )}
            </div>
